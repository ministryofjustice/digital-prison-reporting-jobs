...
public class JobArguments {
    ...
    public static final String ARCHIVED_FILES_CHECK_PERIOD_AMOUNT = "dpr.raw.file.archive.period.amount";
    public static final Long DEFAULT_ARCHIVED_FILES_CHECK_PERIOD_AMOUNT = 2L;
    public static final String ARCHIVED_FILES_CHECK_PERIOD_UNIT = "dpr.raw.file.archive.period.unit";
