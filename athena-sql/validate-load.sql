...
FROM
    (
        SELECT
                (SELECT count(*)
                 FROM "dms_raw"."oms_owner_agency_internal_locations_load_only") As raw_total,
        ...
        SELECT
                (SELECT count(*)
                 FROM "dms_raw"."oms_owner_agency_locations_load_only") As raw_total,
        ...
        SELECT
                (SELECT count(*)
                 FROM "dms_raw"."oms_owner_movement_reasons_load_only") As raw_total,
        ...
        SELECT
                (SELECT count(*)
                 FROM "dms_raw"."oms_owner_offender_bookings_load_only") As raw_total,
        ...
        SELECT
                (SELECT count(*)
                 FROM "dms_raw"."oms_owner_offender_external_movements_load_only") As raw_total,
        ...
        SELECT
                (SELECT count(*)
                 FROM "dms_raw"."oms_owner_offenders_load_only") As raw_total,
