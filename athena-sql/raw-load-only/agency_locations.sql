CREATE EXTERNAL TABLE `dms_raw`.`oms_owner_agency_locations_load_only`
(
    `Op`                            string COMMENT '',
    ...
    LOCATION
        's3://dpr-dms-raw-zone-development/OMS_OWNER/AGENCY_LOCATIONS/_symlink_format_load_only_manifest'
    TBLPROPERTIES (
