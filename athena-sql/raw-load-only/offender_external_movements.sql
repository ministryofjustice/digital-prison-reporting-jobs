CREATE EXTERNAL TABLE `raw`.`nomis_offender_external_movements_load_only`
(
    `Op`                            string COMMENT '',
    ...
    LOCATION
        's3://dpr-raw-zone-test/nomis/offender_external_movements/_symlink_format_load_only_manifest'
    TBLPROPERTIES (
